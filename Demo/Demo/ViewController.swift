...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let items = [DemoItem(value: "Most Popular Most Popular Most Popular Most Popular Most Popular", selectable: true),
                     DemoItem(value:"Latest",selectable: true),
                     DemoItem(value:"Trending",selectable: true),
                     DemoItem(value:"Nearest",selectable: true),
                     DemoItem(value:"Top Picks",selectable: false)]
